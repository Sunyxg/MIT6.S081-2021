...
ls(char *path)
{
 ...
 1f4:	8b8a0a13          	addi	s4,s4,-1864 # aa8 <malloc+0x118>
...
main(int argc, char *argv[])
{
 ...
 2be:	81650513          	addi	a0,a0,-2026 # ad0 <malloc+0x140>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 642:	4a250513          	addi	a0,a0,1186 # ae0 <digits>
 646:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 70e:	3d6b8b93          	addi	s7,s7,982 # ae0 <digits>
 ...
 84e:	28e90913          	addi	s2,s2,654 # ad8 <malloc+0x148>
        while(*s != 0){
...
free(void *ap)
{
 ...
 916:	1e67b783          	ld	a5,486(a5) # af8 <freep>
 ...
 944:	00e6ea63          	bltu	a3,a4,958 <free+0x50>
{
 ...
 986:	16f73b23          	sd	a5,374(a4) # af8 <freep>
}
 98a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 9b8:	14453503          	ld	a0,324(a0) # af8 <freep>
 ...
 9e0:	11c90913          	addi	s2,s2,284 # af8 <freep>
  if(p == (char*)-1)
 9e4:	5afd                	li	s5,-1
 9e6:	a88d                	j	a58 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 9e8:	00000797          	auipc	a5,0x0
 9ec:	12878793          	addi	a5,a5,296 # b10 <base>
 9f0:	00000717          	auipc	a4,0x0
 9f4:	10f73423          	sd	a5,264(a4) # af8 <freep>
 9f8:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a1a:	0ea73123          	sd	a0,226(a4) # af8 <freep>
      return (void*)(p + 1);
